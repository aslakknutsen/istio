...
proto: operator-proto dns-proto echo-proto workload-proto zds-proto gwxds-proto
...
gwxds-proto:
	buf generate --config $(BUF_CONFIG_DIR)/buf.yaml --path pkg/gwxdsapi --output pkg --template $(BUF_CONFIG_DIR)/buf.golang-json.yaml
