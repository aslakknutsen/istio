...
replace sigs.k8s.io/gateway-api => github.com/aslakknutsen/gateway-api v0.0.0-20260210200924-d7f383de4148

exclude sigs.k8s.io/gateway-api/conformance v0.0.0-20260209154325-37aa34a270ae
